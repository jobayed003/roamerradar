...
const CategoryFilter = ({ filters, selectItems }: { filters: string[]; selectItems: string[] }) => {
        ...
        <div className='lg:flex hidden gap-x-2'>
          {filters.map((item) => (
            <div
              ...
              className={cn(
                'rounded-full px-2 py-1 font-bold text-sm bg-transparent text-gray_text dark:text-gray_text dark:hover:text-white hover:text-black transition-all select-none',
                selected === item &&
