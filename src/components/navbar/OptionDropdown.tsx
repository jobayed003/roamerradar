...
const Options = ({ ref }: { ref: Ref<HTMLDivElement> | undefined }) => {
  return (
    <motion.div
      className={
        'text-black bg-white w-[280px] p-4 absolute top-14 left-[-80px] right-0 flex-col items-start justify-start gap-y-4 rounded-2xl dark:bg-dark_bg dark:text-gray_text shadow-2xl dark:shadow-[0px_10px_32px_#23262F] z-[10000] '
      }
      ref={ref}
      key={'option'}
