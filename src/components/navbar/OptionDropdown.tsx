...
const Options = ({ ref }: { ref: Ref<HTMLDivElement> | undefined }) => {
  return (
    <motion.div
      className={
        'text-black bg-white w-[280px] p-4 absolute top-14 left-[-80px] right-0 flex-col items-start justify-start gap-y-4 rounded-2xl  dark:bg-[#141416] dark:text-[--text-primary] drop-shadow-2xl z-10 '
      }
      ref={ref}
      key={'option'}
