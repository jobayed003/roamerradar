...
import { cn, createSearchParams, dateFormat } from '@/lib/utils';
...
const Cars = () => {
  ...
  const searchHref = useMemo(
    () =>
      createSearchParams({
        baseUrl: '/cars-category',
        params: pickupLocation.trim() || 'London',
      }),
    [pickupLocation]
  );
            ...
            <div className='grid grid-cols-2'>
              <div className='flex flex-col items-start '>
                <div className='flex items-center'>
                  ...
                  >
                    {date?.from ? dateFormat(date.from) : 'Pick-up'}
                  </Button>
                </div>
              ...
              <div className='flex items-start flex-col'>
                <div className='flex items-center'>
                  ...
                  >
                    {date?.to ? dateFormat(date.to) : 'Drop-off'}
                  </Button>
                </div>
                <p className='ml-10 text-muted-foreground'>Add date</p>
              </div>
