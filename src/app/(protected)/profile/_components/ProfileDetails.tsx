...
const ProfileDetails = () => {
  return (
    <div className='rounded-3xl border dark:bg-[#141416] bg-background dark:border-gray_border px-20 py-4 flex flex-col items-center lg:-mt-32 z-[300] h-max lg:w-2/3 text-center'>
      ...
      <div className='flex gap-x-4 dark:bg-[#23262F] bg-[#F4F5F6] rounded-2xl px-8 py-1 my-8 text-[--text-primary] font-poppins text-xs'>
